...
function SlideFour({ onRestart }: { onRestart: () => void }) {
  return <section className="slide slide-four" aria-labelledby="slide-four-title">
    ...
    <div className="slide-content"><Eyebrow number="04 / 04">The shipped system</Eyebrow><div className="final-layout"><div><p className="kicker light"><span className="live-ping" /> WEB + NATIVE iOS / AVAILABLE NOW</p><h2 id="slide-four-title">Less assistant.<br /><em>More resolution.</em></h2><p className="final-copy">Armani combines interruptible speech, camera understanding, live web research, and conversational memory. A frame is captured only when the user asks, and Armani does not save it.</p><button className="replay-button" onClick={onRestart}><Play size={15} /> Replay the story</button></div><div className="system-stack"><div className="stack-label">ARMANI RUNTIME</div><div className="stack-row"><span className="stack-icon"><Headphones size={17} /></span><span><b>Natural voice</b><small>Short turns + interruption</small></span><span className="stack-live">LIVE</span></div><div className="stack-row"><span className="stack-icon"><Camera size={17} /></span><span><b>Camera vision</b><small>Front / back camera, frame on ask</small></span><span className="stack-live">LIVE</span></div><div className="stack-row"><span className="stack-icon"><Globe2 size={17} /></span><span><b>Live web research</b><small>Visual clues shape the search</small></span><span className="stack-live">LIVE</span></div><div className="stack-row"><span className="stack-icon"><BrainCircuit size={17} /></span><span><b>Resolve state</b><small>One step, follow-up, verify</small></span><span className="stack-live">LIVE</span></div><div className="stack-bottom"><span>ARMANI / RESOLVE</span><span>SHOW IT. SOLVE IT.</span></div></div></div></div>
